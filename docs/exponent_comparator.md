...
**\*\*Note:** CLA can be replaced with a generalized adder block, could use different PPA architectures (such as Kogge-Stone, Brent Kung, Ladner-Fischer, Serial Prefix, etc.)